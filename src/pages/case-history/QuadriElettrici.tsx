  ...
  const articles = [
    {
      ...
      description: "[Placeholder: breve descrizione della case history dei quadri]",
      href: "/case-history/quadri-elettrici/dettaglio",
    },
  ];

  return (
    <PageLayout
      title="Case History: Quadri elettrici"
      subtitle="[Placeholder: introduzione alle case history dei quadri elettrici]"
      breadcrumbs={[
      ...
      <div className="space-y-8">
        ...
        <div>
          <p className={`text-lg ${isDark ? "text-white/70" : "text-black/70"}`}>
            [Placeholder: introduzione alle case history relative ai quadri
            elettrici. Progetti realizzati, soluzioni personalizzate,
            collaborazioni con clienti industriali.]
          </p>
        </div>
...
export default CaseHistoryQuadri;
